CREATE OR REPLACE PROCEDURE assertcloth_reportcloth
(MyClothID integer, MyClothName text, MyClothDescription text, MyClothRating integer, MyClothSize integer,
